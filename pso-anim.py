...
COGNITIVE_COEFF = 1.0      # Coeficiente cognitivo
SOCIAL_COEFF = 1.0         # Coeficiente social
...
def animate(i):
    ...
    ax.set_xlabel("X")
    ax.set_ylabel("Y")
    ax.set_title(f'Iteração {i}/{actual_iterations-1} | Melhor Z: {np.min(current_fitnesses):.2f}', fontsize=16)
